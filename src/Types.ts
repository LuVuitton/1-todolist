import {addEditedListTitleAC, addListAC, removeListAC} from "./reducers/listReducers";
...
export type mainACListType = addListACType | removeListACType | addEditedListACTitleType
...
export type mainACTaskType = addTaskACType | removeTaskACType | switchCheckboxACType | addEditedTaskACType | addArrTasksACType;
